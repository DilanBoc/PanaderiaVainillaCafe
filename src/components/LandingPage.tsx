...
import { Croissant, Menu as MenuIcon, X, ShoppingCart, Coffee, Package, Send, ChevronDown, Leaf, Heart, ArrowRight, MapPin, Clock, Phone, Navigation, ExternalLink, MessageCircle } from 'lucide-react';
    ...
    <div className="min-h-screen font-sans">
      ...
      <nav className={`fixed w-full z-[100] transition-all duration-500 ${isScrolled ? 'py-2' : 'py-4'}`} id="main-nav">
        <div className={`max-w-7xl mx-auto transition-all duration-500 ${isScrolled ? 'px-4' : 'px-6 lg:px-12'}`}>
          <div className="flex justify-between items-center bg-white/70 backdrop-blur-md rounded-2xl px-6 py-3 border border-white/20 shadow-sm">
            ...
            <div className="hidden md:flex items-center gap-8 font-medium text-sm text-stone-600">
              ...
              <a href="#menu" className="hover:text-[#7B3F00] transition-colors">Nuestro Menú</a>
              <a href="#contacto" className="hover:text-[#7B3F00] transition-colors">Contacto</a>
            </div>

            <div className="flex items-center gap-4">
              <a href="https://wa.me/573202381555" className="hidden sm:block bg-[#7B3F00] text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-[#5D2F00] transition-all shadow-md active:scale-95">
                Hacer Pedido
              </a>
              <button 
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="md:hidden mt-2 bg-white rounded-2xl p-6 border border-stone-100 shadow-xl animate-in slide-in-from-top-4 duration-300">
              <div className="flex flex-col gap-4 font-medium text-stone-600">
                <a href="#inicio" onClick={() => setIsMenuOpen(false)} className="hover:text-[#7B3F00] py-2 border-b border-stone-50">Inicio</a>
                <a href="#masa-madre" onClick={() => setIsMenuOpen(false)} className="hover:text-[#7B3F00] py-2 border-b border-stone-50">Masa Madre</a>
                <a href="#menu" onClick={() => setIsMenuOpen(false)} className="hover:text-[#7B3F00] py-2 border-b border-stone-50">Nuestro Menú</a>
                <a href="#contacto" onClick={() => setIsMenuOpen(false)} className="hover:text-[#7B3F00] py-2">Contacto</a>
                <a href="https://wa.me/573202381555" className="bg-[#7B3F00] text-white px-5 py-4 rounded-xl text-center font-bold mt-2">
                  Hacer Pedido
                </a>
              </div>
            </div>
      ...
      {/* Hero Section */}
      <section id="inicio" className="relative h-screen min-h-[600px] flex items-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-base sm:text-lg md:text-xl text-stone-100/90 mb-10 font-light leading-relaxed max-w-xl">
              Descubre el sabor auténtico de Melgar. Panes de fermentación lenta, granizados únicos y el aroma dulce que te hace sentir en casa.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#contacto" className="bg-transparent border border-white/40 backdrop-blur-sm text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all text-center">
                Ubicación
              </a>
            </div>
          </div>
      ...
      {/* Masa Madre Section */}
      <section id="masa-madre" className="py-20 md:py-32 px-6 bg-[#FDF9F3]">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 md:gap-20 items-center">
            <div className="lg:col-span-5 relative">
              <div className="aspect-[4/5] sm:aspect-square lg:aspect-[4/5] rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-2xl relative z-10">
              ...
              <div className="absolute -bottom-10 -left-10 w-48 sm:w-64 h-48 sm:h-64 bg-orange-100 rounded-full blur-3xl -z-0 opacity-60"></div>
              
              <div className="absolute -bottom-6 -right-4 sm:-right-6 bg-white p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl z-20 max-w-[150px] sm:max-w-[200px] border border-stone-100">
                <p className="text-3xl sm:text-4xl font-serif font-bold text-[#7B3F00]">48h</p>
                <p className="text-[10px] sm:text-xs uppercase font-bold tracking-widest text-stone-500">De fermentación natural</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 lg:pl-10">
              ...
              <p className="text-base sm:text-lg text-stone-600 mb-8 leading-relaxed">
                No es solo pan, es un proceso vivo. En Vainilla y Canela, nuestra masa madre es el corazón de la casa. Creada con agua y harina de la mejor calidad, logramos una corteza crujiente, un aroma profundo y una miga aireada que es amable con tu digestión.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-12">
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-stone-100 shadow-sm">
                  ...
                  <div>
                    <h5 className="font-bold text-sm sm:text-base">Sin Levaduras</h5>
                    <p className="text-xs text-stone-500">Proceso 100% biológico y natural.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-stone-100 shadow-sm">
                  <Heart className="w-6 h-6 text-red-500 shrink-0" />
                  <div>
                    <h5 className="font-bold text-sm sm:text-base">Digestivo</h5>
                    <p className="text-xs text-stone-500">Bajo índice glucémico y mejor absorción.</p>
                  </div>
                </div>
              </div>

              <a href="https://wa.me/573202381555?text=Hola!%20Me%20encantaría%20probar%20su%20famoso%20Pan%20de%20Masa%20Madre" target="_blank" className="inline-flex items-center justify-center gap-3 bg-[#7B3F00] text-white px-8 sm:px-10 py-4 sm:py-5 rounded-2xl font-bold hover:shadow-2xl transition-all hover:scale-105 active:scale-95 w-full sm:w-auto">
                Pedir mi Hogaza Ahora
      ...
      <section id="menu" className="py-20 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
            ...
            <p className="text-stone-500 text-sm sm:text-base">Hecho cada mañana con ingredientes frescos y locales de Melgar.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {filteredProducts.map((product) => (
              <div key={product.id} className="card-shadow bg-white rounded-[2rem] overflow-hidden border border-stone-100 flex flex-col h-full group">
                ...
                <div className="p-6 sm:p-8 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <a href={`https://wa.me/573202381555?text=Hola!%20Quiero%20una%20${product.name}`} className="bg-green-50 text-green-700 p-2.5 sm:p-3 rounded-2xl hover:bg-green-600 hover:text-white transition-all shadow-sm">
      ...
      {/* Contact Section */}
      <section id="contacto" className="py-20 md:py-32 bg-stone-950 text-white overflow-hidden relative">
        <div className="absolute top-0 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-[#7B3F00] blur-[100px] sm:blur-[120px] opacity-20 -z-0"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 md:gap-20 items-center">
            <div>
              ...
              <p className="text-stone-400 text-base sm:text-lg mb-10 sm:mb-12 max-w-lg">
                El Barrio La Florida te espera con el aroma del pan recién horneado. Ven a compartir un momento especial con nosotros.
              </p>
            ...
            <div className="relative">
              <div className="bg-stone-800 rounded-[2.5rem] sm:rounded-[3rem] p-3 sm:p-4 shadow-2xl border border-stone-700 h-[350px] sm:h-[450px] overflow-hidden relative">
                <div className="w-full h-full bg-stone-900 rounded-[2rem] sm:rounded-[2.5rem] flex flex-col items-center justify-center text-center p-6 sm:p-10 group overflow-hidden">
                  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1526772662000-3f88f10405ff?auto=format&fit=crop&q=80&w=1000')] opacity-20 group-hover:scale-110 transition-transform duration-1000 grayscale"></div>
      ...
      <footer className="bg-stone-950 border-t border-stone-800 py-16 sm:py-20 px-6 text-center md:text-left">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex gap-6 sm:gap-8 text-stone-400 font-medium text-xs sm:text-sm">
            ...
            <a href="https://wa.me/573202381555" className="hover:text-green-500 transition-colors">WhatsApp</a>
          </div>

          <p className="text-stone-600 text-[10px] sm:text-xs">
            &copy; 2024 Vainilla & Canela. Calle 7B #11-61, Melgar.
          </p>
        </div>
      </footer>

      {/* Floating WhatsApp */}
      <a href="https://wa.me/573202381555" target="_blank" className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[200] whatsapp-float group">
